  ...
  <div class="grid grid-cols-1 md:grid-cols-2 mx-6 mt-6 gap-6">
    ...
    <div>
      ...
      <ul class="text-gray-700 space-y-2 list-disc list-inside">
        ...
        <li>
          Workshop Creation - Design, market, and run educational workshops for
          students and teachers.
        </li>
        <li>
          Consulting - Analyze educational needs and provide client tailored
          solutions.
        </li>
        <li>
          Content Creation - Create textbook materials for Japanese EFL
          publishers.
        </li>
      </ul>
    </div>
